...
const updatedBank = {
  meta: {
    title: "University Duel Practice Question Bank",
    categories: ["Applied Math", "Data Analysis", "Verbal Reasoning", "General Knowledge"],
    difficulty_scale: ["easy", "medium", "hard"],
    format: "buzz-in, free-answer (with optional multiple choice reference) — matches the real competition's format",
    notes: "Official University Duel questions provided for practice."
  },
  questions: finalQuestions
};

fs.writeFileSync(jsonPath, JSON.stringify(updatedBank, null, 2));
console.log('Successfully set question bank to ONLY the 34 new questions! Total questions:', finalQuestions.length);
